        ...
        <Grid container spacing={5} style = {{ marginTop : '20px', marginLeft : '-30px'}}>
            <Grid item xs={12} sm={6} md={4} lg={5}>
                <AdminCardComponent
                  ...
                  onClick={() => handleCardClick('/dashboard/manage-events')}
                />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={3}>
                <AdminCardComponent
                  ...
                  onClick={() => handleCardClick('/dashboard/manage-users')}
                />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={5}>
                <AdminCardComponent
                  ...
                  onClick={() => handleCardClick('/dashboard/view-registrations')}
                />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={5}>
                <AdminCardComponent
                  ...
                  onClick={() => handleCardClick('/dashboard/all-events')}
                />
            </Grid>
        </Grid>
  );
