...
const UserNavbar = () => {
  ...
  return (
    <div>
      <AppBar position="static" className = 'userAppbar' sx={{backgroundColor : 'rgba(0, 0, 0, 0.6)', backdropFilter : 'blur(5px)', width: '100vw', boxShadow: '5px 5px 70px gray', borderBottom : '0px' }}>
